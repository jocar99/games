...
function LevelMaker.createMap(level)
    ...
    for y = 1, numRows do
        ...
        --testing
        --[[local alternateColor1 = 5
        local alternateColor2 = 5
        local alternateTier1 = 1
        local alternateTier2 = 1
        ...
        for x = 1, numCols do
            ...
            if alternatePattern and alternateFlag then
                ...
                if alternatePattern and not alternateFlag then
